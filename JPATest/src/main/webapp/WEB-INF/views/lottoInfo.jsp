	            ...
	            $('#schLottoInfoTb2 > tbody').empty();
  				...
  				if(json.drwtNo1 != ""){
	             	res+="<tr id='schLottoInfoTr' name='schLottoInfoTr'>"
	                		+"<td width='70'>"+json.drwNo+"</td>"
	                		+"<td width='70'>"+json.drwtNo1+"</td>"
	                		+"<td width='70'>"+json.drwtNo2+"</td>"
	                		+"<td width='70'>"+json.drwtNo3+"</td>"
	                		+"<td width='70'>"+json.drwtNo4+"</td>"
	                		+"<td width='70'>"+json.drwtNo5+"</td>"
	                		+"<td width='70'>"+json.drwtNo6+"</td>"
	                		+"<td width='100'>"+json.bnusNo+"</td>"
	                		+"<td width='100'>"+json.drwNoDate+"</td>"
                }else{
                	res+="<tr id='schLottoInfoTr' name='schLottoInfoTr'>"
...
<body>
	...
	<form name="schLottoInfoFm" id="schLottoInfoFm" action="schLottoInfo">		
		...
		<table id="schLottoInfoTb2" name="schLottoInfoTb2">		
			<tr>
				<td width="70">${drwNo}</td>
				<td width="70">${drwtNo1}</td>
				<td width="70">${drwtNo2}</td>
				<td width="70">${drwtNo3}</td>
				<td width="70">${drwtNo4}</td>
				<td width="70">${drwtNo5}</td>
				<td width="70">${drwtNo6}</td>
				<td width="100">${bnusNo}</td>
				<td width="100">${drwNoDate}</td>
			</tr>
		</table>
		</div>
	</form>
