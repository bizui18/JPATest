...
<script>
	...
	function fnCrtLottoNo(){
		...
		//document.getElementById("crtLottoDiv").style.display = "block";
	            ...
	            if(json.length > 0){
		            for(let i=0;i<json.length;i++){
		             	res+="<tr id='myLottoNoTr' name='myLottoNoTr' onmouseover=\"this.style.background='#87CEFA'\" onmouseout=\"this.style.background='white'\">"
		                		+"<td width='200'>"+json[i].crtDate.replace('T',' ')+"</td>"
		                		+"<td width='70'>"+json[i].drwtNo1+"</td>"
		                		+"<td width='70'>"+json[i].drwtNo2+"</td>"
		                		+"<td width='70'>"+json[i].drwtNo3+"</td>"
		                		+"<td width='70'>"+json[i].drwtNo4+"</td>"
		                		+"<td width='70'>"+json[i].drwtNo5+"</td>"
		                		+"<td width='70'>"+json[i].drwtNo6+"</td>"
		                		+"<td><input type='button' value='삭제' onClick=\"fnDelMyLottoNo('"+json[i].no+"')\" /></td></tr>";
		            }
	            }else{
...
<body>
	...
	<form id="crtLottoNoFm" name="crtLottoNoFm" action="myLottoNoIns" method="GET">
		...
		<table>
			...
			<tr>
				<td width="70"><input type="text" id="drwtNo1" name="drwtNo1" style="width:90%;text-align:right" value=""/></td>
				<td width="70"><input type="text" id="drwtNo2" name="drwtNo2" style="width:90%;text-align:right" value=""/></td>
				<td width="70"><input type="text" id="drwtNo3" name="drwtNo3" style="width:90%;text-align:right" value=""/></td>
				<td width="70"><input type="text" id="drwtNo4" name="drwtNo4" style="width:90%;text-align:right" value=""/></td>
				<td width="70"><input type="text" id="drwtNo5" name="drwtNo5" style="width:90%;text-align:right" value=""/></td>
				<td width="70"><input type="text" id="drwtNo6" name="drwtNo6" style="width:90%;text-align:right" value=""/></td>
			</tr>
		</table>
		</div>
	</form>
	...
	<form id="myLottoNoFm" name="myLottoNoFm" action="myLottoNoSel" method="GET">
		...
		<table id="myLottoNoTb1" name="myLottoNoTb1">
			...
			<tr style="background-color:#00BFFF">
				...
				<td width="70">번호 5</td>
				<td width="70">번호 6</td>
				<td><input type="button" value="조회" onClick="fnSchMyLottoNo()" /></td>
			</tr>		
		</table>
